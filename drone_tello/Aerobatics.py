...
socket.sendto('flip f'.encode('utf-8'), tello_addr)
print(f'Sending Command: flip f to {tello_addr}')
time.sleep(4)

socket.sendto('flip r'.encode('utf-8'), tello_addr)
print(f'Sending Command: flip r to {tello_addr}')
time.sleep(4)

socket.sendto('flip b'.encode('utf-8'), tello_addr)
print(f'Sending Command: flip b to {tello_addr}')
time.sleep(4)

socket.sendto('flip l'.encode('utf-8'), tello_addr)
print(f'Sending Command: flip l to {tello_addr}')
time.sleep(4)
